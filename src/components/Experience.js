    ...
    <div>
      ...
      <div className="experience-container">
          ...
          <span className="flex type-date">
            ...
            <p className="experience-dates">Jun 2025 –  Current</p>
          </span>
        ...
        <div className="experience-item">
          ...
          <span className="flex type-date">
            ...
            <p className="experience-dates">Jun 2023 – May 2023</p>
          </span>
          <p className="experience-detail">
            <p className="experience-detail">
            <p className="experience-detail">
        ...
        <div className="experience-item">
          ...
          <span className="flex type-date">
            ...
            <p className="experience-dates">Sep 2025 – Current</p>
          </span>
          <p className="experience-detail">
            Assist with daily operations, child supervision, and community or holiday event support
          </p>
        </div>
         <div className="experience-item">
      
          <span className="flex type-date">
            <h3 className="experience-company">STEM Unique</h3>
            <p className="experience-dates">Feb 2026 – Current</p>
          </span>
          <p className="experience-detail">
            Support themed STEM workshops (circuits, coding, etc.) by providing technical guidance and student supervision
          </p>
        </div>
      </div>
    </div>
